...
public class RSSImage {
	...
	public RSSImage(String description, String height, String link,
			String title, String url, String width, Bitmap imagen) {
	...
	public RSSImage(String link, String title, String url, Bitmap imagen) {
		this("NoDesc", "NoHeight", link, title, url, "NoWidth", imagen);
	}
